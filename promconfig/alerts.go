...
func isAlertRuleFileName(name string) bool {
	switch {
	case strings.HasSuffix(name, ".yaml"), strings.HasSuffix(name, ".yml"):
		return true
	case strings.HasSuffix(name, ".yaml"+workspace.JobTemplateExt),
		strings.HasSuffix(name, ".yml"+workspace.JobTemplateExt):
		return true
	default:
		return false
	}

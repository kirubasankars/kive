...
| `--wait` | Retry until pass (default `health.wait_seconds` from `kive.conf`, usually 180) |
...
See also: [disable and drain](../guide/disable-and-drain.md), [rolling deploy](../guide/rolling-deploy.md), [First deploy](../tutorial/02-first-deploy.md).

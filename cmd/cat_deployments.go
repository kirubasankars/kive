...
var catDeploymentsCmd = &cobra.Command{
	...
	Long: `Show pending_hash and applied_hash per allocation for deploy debugging.

Use --jobs and --workers to filter (comma-separated, same as kive cat allocations).
